...
ActSeq1 = ActSeq4E + ActSeq4I2 + [
    ...
    ["..@...#...#.[^B].#...#...",[[D_UP,A_WALK]],[[D_UP,A_WALK]],[[D_UP,A_SEARCH]]],
...
es_clear
queue = [[D_RIGHT,A_SEARCH],[D_LEFT,A_SEARCH],[D_UP,A_SEARCH],[D_DOWN,A_SEARCH]]
...
# 敵がいなかったら@mymap見てsaveしてあるところをブロックにする処理
    if  !values[1,9].include?(M_CHARA) then
        (1..9).each do |i|
